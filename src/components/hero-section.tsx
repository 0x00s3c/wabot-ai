        ...
        <>
            <motion.section
                ...
                <div className={"container relative mt-16"}>
                    <h1 className={"text-8xl md:text-[168px] md:leading-none font-semibold bg-white tracking-tighter bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,0.5))] bg-clip-text text-transparent text-center"}>WABOT-1</h1>
                    <p className={"text-lg md:text-xl max-w-xl mx-auto text-white/70 mt-5 text-center"}>Wabot-1 (1996) is a significant milestone in robotics and artificial intelligence history.</p>
                    <p className={"text-lg md:text-xl max-w-xl mx-auto text-white/70 mt-5 text-justify"}>WABOT-1 (1966) Developed by Hitachi Ltd. and Japan Ministry of International Trade and Industry (MITI), WABOT-1 was:</p>
                    <p className={"text-lg md:text-xl max-w-xl mx-auto text-white/70 mt-5 text-justify"}>
                        1. The first full-scale humanoid robot<br></br>
                        2. Designed for assembly and welding tasks<br></br>
                        3. Equipped with:
