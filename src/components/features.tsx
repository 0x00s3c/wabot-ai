...
import ProductImage from "@/assets/logo-wabot.png";
...
const tabs = [
    ...
    },
    {
        ...
        title: "No existing humanoid robot designs",
        isNew: false,
    ...
    },
    {
        ...
        title: "Integrating AI and robotics",
        isNew: true,
            ...
            <section className={"py-20 md:py-24"}>
                <div className={"container"}>
                    ...
                    <p className={"text-white/70 text-lg md:text-xl max-w-2xl mx-auto text-center tracking-tight mt-5"}>
                        Developing WABOT-1 was a daunting task:
                    </p>
